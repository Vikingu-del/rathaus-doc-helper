...
def backend(request):
    ...
    documents = {
        "enrollment": os.path.join(settings.MEDIA_ROOT, "EnrollmentLetterSample.pdf"),
        "insurance": os.path.join(settings.MEDIA_ROOT, "HealthInsuranceSample.pdf"),
        "blocked": os.path.join(settings.MEDIA_ROOT, "BlockedAccountSample.pdf"),
        "residence": os.path.join(settings.MEDIA_ROOT, "HouseRegistrationSample.pdf"),
        "identity": os.path.join(settings.MEDIA_ROOT, "passport.jpg"),
    }
    ...
    return render(request, 'form_display.html', {'form_data': frontend})
